                ...
                <React.Fragment key={index}>
                  <tr className="border-b-2 h-[91px]">
                    ...
                    <td className="border-zinc-300 text-[16px] font-normal p-2">
                      <span className={`font-body bg-[#E3EEFF] justify-center items-center flex p-1 gap-1 rounded-full ${campaign.status === "Live" ? "text-[#363939]" : ""}`}>
                        <FaCircleDot className="w-[14px] h-[14px] text-[#0066FF]" /> {campaign.status}
                      </span>
                    </td>
                    ...
                    <td className="border-zinc-300 text-[16px] font-normal font-body p-2">
                      <button className="text-[#000000] flex items-center px-6 py-2  font-body text-[14px] font-normal border border-[#B6B6B6] rounded-lg cursor-pointer">Edit </button>
                    </td>
                    <td className="border-zinc-300 p-2">
                      <button className="text-[#0066FF] flex items-center font-body text-[14px] font-normal cursor-pointer" onClick={() => toggleDetails(index)}>
    ...
    <td colSpan="8">
      <div className="flex flex-col md:flex-row rounded-lg p-2 overflow-hidden">
        ...
        <div className='mt-6 p-3 space-y-2 border-l-2 border-[#D2D3D3]'>
          <div>
            <button className="text-[#0066FF] font-body text-[16px] font-normal">Manage campaign</button>
          </div>
          <div>
            <button className="text-[#363939] font-body text-[16px] font-normal">Edit campaign</button>
          </div>
          <div>
            <button className="text-[#FA6A5E] font-body text-[16px] font-normal">Stop campaign</button>
          </div>
        </div>
      </div>
    </td>
